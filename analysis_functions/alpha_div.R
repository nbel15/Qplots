...
# Script: Alpha diversity (Analysis functions)
...
alpha_div <- function(physeq,method){
  ...
  method<- match.arg(method,c("richness", "fisher", "simpson", "shannon", "evenness","pd", "goods", "ace", "chao", "obs.otus"), several.ok = TRUE)
